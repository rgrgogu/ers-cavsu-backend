...
const obj = new Schema({
    ...
    role: { type: String, required: true, index: true, default: 'Registrar'},
    isArchived: { type: Boolean, required: true, index: true, default: false },
    profile: { type: Schema.Types.ObjectId, ref: 'reg_profile', default: null },
}, {
    virtuals: {
...
module.exports = mongoose.model("reg_login", obj);
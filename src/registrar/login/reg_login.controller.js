...
const User = require("./reg_login.model");
...
const Login = async (req, res) => {
  try {
      ...
      const checkResult = await CheckUser(user, password, "Registrar");
...
const Register = async (req, res) => {
  try {
    ...
    const user_id = `REG-${year}${paddedCount}`; // e.g., 2025000001

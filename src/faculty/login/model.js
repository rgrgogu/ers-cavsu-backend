...
const obj = new Schema({
    ...
    role: { type: String, required: true, index: true, default: 'Faculty'},
    isArchived: { type: Boolean, required: true, index: true, default: false },
    profile: { type: Schema.Types.ObjectId, ref: 'fac_profile', default: null },
}, {
    virtuals: {
...
module.exports = mongoose.model("fac_login", obj);